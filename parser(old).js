    ...
    var peg$FAILED = {},
        ...
        peg$c12 = function(head, tail) {
              return tail.reduce(function(result, element) {
                if (element[1] === "^") { 
                if(element[3]) {
                return result ** (element[3].concat(element[4])); 
                } else {
        ...
        peg$c13 = "log",
        peg$c14 = peg$literalExpectation("log", false),
        peg$c15 = function(head, tail) {
              return tail.reduce(function(result, element) {
                if (element[1] === "log") { return Math.log(element[3]) / Math.log(10); }
              }, head);
            },
        peg$c16 = "(",
        ...
        peg$c26 = function(digits) { return parseFloat(digits.join(""), 10);},
